...
const SessionStep = () => {
  ...
  const recommendedSession = selectedEmotion
    ? recommendations[selectedEmotion]
        ...
        <div className="md:w-[55%] p-10 md:p-12 flex flex-col justify-between gap-8">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[8px] font-bold uppercase tracking-[0.3em] text-gold mb-0.5">
                  Focus
                </p>

                <p className="text-sm font-medium text-text-dark">
                  {recommendedSession.benefit}
                </p>
              </div>
            </div>
